...
INNER JOIN TARJETA_CLIENTE TC ON TC.NUMRUN = C.NUMRUN
INNER JOIN PROVINCIA P ON P.COD_PROVINCIA = C.COD_PROVINCIA
AND P.COD_REGION = C.COD_REGION
LEFT JOIN TRANSACCION_TARJETA_CLIENTE TTC ON TTC.NRO_TARJETA = TC.NRO_TARJETA
GROUP BY TO_CHAR(C.NUMRUN,'09G999G999')||'-'||DVRUN,PNOMBRE,SNOMBRE,APPATERNO,APMATERNO,C.DIRECCION,R.NOMBRE_REGION,P.NOMBRE_PROVINCIA
ORDER BY APPATERNO;
